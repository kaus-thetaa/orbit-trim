...
let smoothedTilt = 0;
const filterAlpha = 1.0;          
const tiltScaleFactor = 15.0;     // <-- Change from 45.0 down to 15.0 (Lower = much more sensitive)   // 45 degrees tilt = 100% rocket throttle (adjust if needed)
